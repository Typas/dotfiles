...
PACKAGES=(fd-find eza ripgrep sd clang gcc make gawk pkg-config libssl-dev editorconfig shellcheck openssh-client unzip cmake curl fontconfig p7zip-full)
