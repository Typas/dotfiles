...
PACKAGES=(fd-find eza ripgrep rust-sd clang gcc make gawk pkg-config libssl-dev editorconfig shellcheck openssh-client unzip cmake curl fontconfig p7zip-full)
